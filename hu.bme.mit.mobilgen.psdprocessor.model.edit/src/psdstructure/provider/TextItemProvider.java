...
/**
 * This is the item provider adapter for a {@link psdstructure.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PsdstructurePackage.Literals.TEXT__TEXT,
				 true,
				 false,
				 false,
	...
	protected void addEditablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_editable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_editable_feature", "_UI_Text_type"),
				 PsdstructurePackage.Literals.TEXT__EDITABLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PsdstructurePackage.Literals.TEXT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Text.class)) {
			case PsdstructurePackage.TEXT__TEXT:
			case PsdstructurePackage.TEXT__EDITABLE:
			case PsdstructurePackage.TEXT__TYPE:
