...
/**
 * This is the item provider adapter for a {@link psdstructure.Grid} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GridItemProvider
	extends ViewGroupItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_cols_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_cols_feature", "_UI_Grid_type"),
				 PsdstructurePackage.Literals.GRID__COLS,
				 true,
				 false,
				 false,
	...
	protected void addRowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_rows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_rows_feature", "_UI_Grid_type"),
				 PsdstructurePackage.Literals.GRID__ROWS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Grid)object).getID();
