...
/**
 * This is the item provider adapter for a {@link psdstructure.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PsdstructurePackage.Literals.VIEW__ID,
				 true,
				 false,
				 false,
	...
	protected void addPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_pos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_pos_feature", "_UI_View_type"),
				 PsdstructurePackage.Literals.VIEW__POS,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_size_feature", "_UI_View_type"),
				 PsdstructurePackage.Literals.VIEW__SIZE,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PsdstructurePackage.Literals.VIEW__BACKGROUNDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PsdstructurePackage.Literals.VIEW__BACKGROUNDS,
				 PsdstructureFactory.eINSTANCE.createBackgroundImage()));
	}
