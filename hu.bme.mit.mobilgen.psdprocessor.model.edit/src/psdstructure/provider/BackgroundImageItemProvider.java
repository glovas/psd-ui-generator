...
/**
 * This is the item provider adapter for a {@link psdstructure.BackgroundImage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BackgroundImageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PsdstructurePackage.Literals.BACKGROUND_IMAGE__IMAGE,
				 true,
				 false,
				 false,
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BackgroundImage_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BackgroundImage_size_feature", "_UI_BackgroundImage_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PsdstructurePackage.Literals.BACKGROUND_IMAGE__POS);
		}
	...
	public String getText(Object object) {
		String label = ((BackgroundImage)object).getImage();
		return label == null || label.length() == 0 ?
			getString("_UI_BackgroundImage_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PsdstructurePackage.Literals.BACKGROUND_IMAGE__POS,
				 PsdstructureFactory.eINSTANCE.createVector()));
	}
